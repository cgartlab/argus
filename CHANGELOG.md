...
- **SKILL.md** — Added Technology Stack Detection section, expanded Review Dimensions with 7th dimension (Framework API Usage), updated Output Format with new fields
- **AGENTS.md** — Added OUTPUT FORMAT section, updated version to 0.3.0
...
- **AGENTS.md** — Updated STRUCTURE with release workflow, WHERE TO LOOK with release automation entry, COMMANDS with `package-skill` target, and NOTES with release workflow documentation
