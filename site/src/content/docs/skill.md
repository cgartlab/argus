...
Direct download link (current latest release):

```
https://github.com/cgartlab/argus/releases/latest/download/argus-skill-v0.4.1.zip
```
...
unzip argus-skill-v0.4.1.zip -d ~/.config/<agent>/skills/argus-design-review
```
